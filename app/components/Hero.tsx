    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl pr-8">
          ...
          <div>
            ...
            <Link
              target="_blank"
              href="https://drive.google.com/file/d/14O6Mlph7RXUXRZTayncVDHoLKC43aYS8/view?usp=drive_link"
